var modulo = angular.module('validationApp', [])
modulo.controller('mainController', function mainController($scope) {
...
modulo.controller('HelloWorld', function HelloWorld($scope) {

     $scope.test = 'Mundo';
});

modulo.controller('AppCtrl',function AppCtrl($scope){
  $scope=(function () {
    'use strict';
